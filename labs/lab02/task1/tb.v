...
module tb;
  ...
  // Declare the three DUT inputs as variables.
  // Use exactly these names: t_i0, t_i1, t_s (needed by $monitor below).
  reg t_i0, t_i1, t_s;

  // Declare the DUT output as a net.
  ...
  initial begin
    // Apply all 8 combinations of t_i0, t_i1 and t_s,
    // keeping each combination for 5 time units.
